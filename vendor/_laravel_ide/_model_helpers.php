...
namespace App\Models {
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<ItemPenjualan>|ItemPenjualan whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ItemPenjualan>|ItemPenjualan wherePenjualanId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ItemPenjualan>|ItemPenjualan whereProdukId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ItemPenjualan>|ItemPenjualan whereKuantitas($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ItemPenjualan>|ItemPenjualan whereHargaSatuan($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ItemPenjualan>|ItemPenjualan whereSubtotal($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ItemPenjualan>|ItemPenjualan whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ItemPenjualan>|ItemPenjualan whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ItemPenjualan>|ItemPenjualan newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<ItemPenjualan>|ItemPenjualan newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<ItemPenjualan>|ItemPenjualan query()
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<ItemPenjualan>|ItemPenjualan timeout(int $seconds)
     ...
     */
    class ItemPenjualan extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\ItemPenjualan> $itemPenjualan
     * @property-read int|null $item_penjualan_count
     * @method static \Illuminate\Database\Eloquent\Builder<Penjualan>|Penjualan whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Penjualan>|Penjualan whereUserId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Penjualan>|Penjualan whereTotalPembayaran($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Penjualan>|Penjualan whereMetodePembayaran($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Penjualan>|Penjualan whereStatus($value)
     ...
     * @method static mixed lockForUpdate()
     * @method static mixed sharedLock()
     * @method static \Illuminate\Database\Eloquent\Builder<Penjualan>|Penjualan timeout(int $seconds)
     * @method static mixed beforeQuery(callable $callback)
     * @method static mixed applyBeforeQueryCallbacks()
     * @method static mixed afterQuery(Closure $callback)
     * @method static mixed applyAfterQueryCallbacks($result)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Produk>|Produk whereHargaBeli($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Produk>|Produk whereHargaJual($value)
     ...
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Penjualan> $penjualan
